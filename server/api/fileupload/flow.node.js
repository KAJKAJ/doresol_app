...
function validateRequest(chunkNumber, chunkSize, totalSize, identifier, filename, fileSize) {
    ...
    if (typeof(fileSize) != 'undefined') {
        ...
        if (numberOfChunks > 1 && chunkNumber == numberOfChunks && fileSize != ((Number(totalSize) % Number(chunkSize)) + Number(chunkSize))) {
...
var write = function(identifier, writableStream, options) {
    options = options || {};
...
var clean = function(identifier, options) {
    options = options || {};
